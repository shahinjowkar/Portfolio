...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>shahin Jowkarz</title>
            <meta name="description" content="Explore articles authored by shahin Jowkar Fiaz, a Full Stack Engineer and Developer." />
